/*
* @(#)DateFormatZoneData_lv.java	1.3 97/02/24
*
 ...
 */
//  Latvia DateFormatZoneData
//
public final class DateFormatZoneData_lv extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"EET", "Eastern European Standard Time", "EEST",
          "Eastern European Daylight Time", "EEDT", "Riga"}
  };
