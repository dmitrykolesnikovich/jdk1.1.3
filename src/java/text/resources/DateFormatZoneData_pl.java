/*
* @(#)DateFormatZoneData_pl.java	1.3 97/02/24
*
 ...
 */
//  Poland DateFormatZoneData
//
public final class DateFormatZoneData_pl extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"ECT", "Central European Standard Time", "CEST",
          "Central European Daylight Time", "CEDT", "Warsaw"}
  };
