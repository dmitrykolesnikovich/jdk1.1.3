/*
 * @(#)LocaleElements_en_IE.java	1.5 97/02/28
 *
...
public class LocaleElements_en_IE extends LocaleData {
  ...
  static String table []={
      "en_IE", /*locale id based on iso codes*/
      "1809", /*Windows id*/
      "eni", /*iso-3 abbrev lang name*/
      "IRL", /*iso-3 abbrev country name*/
      "en_English; de_Englisch; fr_anglais", /*language names*/
      "en_Ireland; de_Irland; fr_Irlande", /*country names*/
      "January", /*january*/
      "February", /*february*/
      "March", /*march*/
      "April", /*april*/
