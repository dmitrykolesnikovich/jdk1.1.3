/*
* @(#)DateFormatZoneData_iw.java	1.2 97/02/24
*
 ...
 */
//  Israel DateFormatZoneData
//
public final class DateFormatZoneData_iw extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"EET", "Eastern European Standard Time", "EEST",
          "Eastern European Daylight Time", "EEDT", "Tel Aviv"}
  };
