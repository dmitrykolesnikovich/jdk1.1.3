/*
* @(#)DateFormatZoneData_ar.java	1.3 97/02/24
*
 ...
 */
//  Egypt DateFormatZoneData
//
public final class DateFormatZoneData_ar extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"ART", "Egypt Standard Time", "EST",
          "Egypt Daylight Time", "EDT", "Cairo"}
  };
