/*
* @(#)DateFormatZoneData_el.java	1.3 97/02/24
*
 ...
 */
//  Greece DateFormatZoneData
//
public final class DateFormatZoneData_el extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"EET", "Eastern European Standard Time", "EEST",
          "Eastern European Daylight Time", "EEDT", "Athens"}
  };
