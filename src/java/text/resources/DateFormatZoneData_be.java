/*
* @(#)DateFormatZoneData_be.java	1.3 97/02/24
*
 ...
 */
//  Belarus DateFormatZoneData
//
public final class DateFormatZoneData_be extends ListResourceBundle
{
  /**
  ...
  private static final String kZoneStrings[][] = {
      {"EET", "Eastern European Standard Time", "EEST",
          "Eastern European Daylight Time", "EEDT", "Minsk"}
  };
