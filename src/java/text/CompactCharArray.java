/*
 * @(#)CompactCharArray.java	1.8 97/01/27
 *
...
final class CompactCharArray implements Cloneable{
  ...
  public void compact()
  {
    if (isCompact == false) {
      ...
      // for each successive block, find out its first
  ...
  public void writeArrays()
  {
    ...
    for (i = 0; i < cnt-1; i++)
    {
      System.out.print("(char)" + (int)getArrayValue(i) + ", ");
      if (i != 0)
        if (i % 10 == 0)
          System.out.println();
    }
